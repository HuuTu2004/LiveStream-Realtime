...
CONFIG_SCHEMA: dict[str, dict] = {
    # ─── TTS / Voice ───────────────────────────────────────────────
    "tts": {"type": "str", "group": "tts", "restart": False, "choices": ["f5tts"],
            "description": "TTS engine (chỉ F5-TTS Vietnamese)"},
    "f5_ref_audio": {"type": "str", "group": "tts", "restart": False,
                     "description": "Đường dẫn WAV reference voice cho cloning"},
    "f5_ref_text": {"type": "str", "group": "tts", "restart": False,
                    "description": "Transcript của reference audio"},
